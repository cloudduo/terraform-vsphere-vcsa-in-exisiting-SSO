...
variable "vcbuild_sso_first_instance" {
  description = "first instance"
}

variable "vcbuild_sso_replication_partner_hostname" {
  description = "replication partner hostname"
}

variable "vcbuild_sso_port" {
  description = "sso port"
}
